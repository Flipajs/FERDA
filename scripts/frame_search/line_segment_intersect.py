...
def do_intersect(pointA, pointB, pointC, pointD):
    ...
    return o1 == 0 and on_segment(pointA, pointC, pointB) or \
            o2 == 0 and on_segment(pointA, pointD, pointB) or \
            o3 == 0 and on_segment(pointC, pointA, pointD) or \
            o4 == 0 and on_segment(pointC, pointB, pointD)
