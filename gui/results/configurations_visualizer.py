...
class ConfigurationsVisualizer(QtWidgets.QWidget):
    def __init__(self, solver, vid):
        ...
        self.cc_number_label = QtWidgets.QLabel('')
    ...
    def create_tool_w(self):
        ...
        self.go_to_frame_b = QtWidgets.QPushButton('go to frame')
        ...
        self.order_by_sb = QtWidgets.QComboBox()
        ...
        w.layout().addWidget(QtWidgets.QLabel('order by: '))
        w.layout().addWidget(self.order_by_sb)

        self.num_processes_label = QtWidgets.QLabel('0')
        w.layout().addWidget(self.num_processes_label)

        self.remove_locks_b = QtWidgets.QPushButton('remove locks')
    ...
    def new_region(self, t_offset=-1):
        ...
        self.d_ = QtWidgets.QDialog()
        self.d_.setLayout(QtWidgets.QVBoxLayout())
    ...
    def chunk_alpha_blending(self):
        ...
        freq, confirmed = QtWidgets.QInputDialog.getInt(self, 'Input Dialog', 'Chunk length is: '+str(chunk.length())+'.Enter frequency:', value=1, min=1)
