...
class LaplacianTest(QtWidgets.QWidget):
    ...
    def make_gui(self):
        ...
        self.slider3 = QtWidgets.QSlider(QtCore.Qt.Orientation.Horizontal, self)
        self.slider3.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.slider3.setRange(1, 100)
        self.slider3.setTickInterval(1)
        self.slider3.setValue(self.sigma1)
        self.slider3.setTickPosition(QtWidgets.QSlider.TickPosition.TicksBelow)
        ...
        self.slider4 = QtWidgets.QSlider(QtCore.Qt.Orientation.Horizontal, self)
        self.slider4.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.slider4.setRange(1, 100)
        self.slider4.setTickInterval(1)
        self.slider4.setValue(self.sigma2)
        self.slider4.setTickPosition(QtWidgets.QSlider.TickPosition.TicksBelow)
