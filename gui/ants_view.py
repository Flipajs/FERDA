...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.imshow_decreasing_factor.setGeometry(QtCore.QRect(190, 49, 60, 27))
        ...
        self.label_4.setGeometry(QtCore.QRect(14, 52, 191, 17))
        ...
        self.b_save_file.setGeometry(QtCore.QRect(190, 59, 98, 27))
        ...
        self.label.setGeometry(QtCore.QRect(288, 35, 66, 20))
        self.label.setObjectName(_fromUtf8("label"))
        self.i_file_name = QtGui.QLineEdit(self.tab_4)
        self.i_file_name.setGeometry(QtCore.QRect(110, 30, 178, 27))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QtGui.QApplication.translate("Dialog", "results", None, QtGui.QApplication.UnicodeUTF8))
