    ...
    def match_gt(self, ants):
        ...
        for i in range(len(ants)):
            ...
            for a_idx in range(len(ants)):
                if my_utils.e_distance(ants[a_idx].state.position, (g[0], g[1])) < self.gt_precission:
                    self.gt_map[i] = a_idx
                    break
    ...
    def check_gt(self, ants, repair=True):
        ...
        for i in range(len(ants)):
            ...
            if a.state.lost:
                ...
                print my_utils.e_distance(a.state.position, (g[0], g[1]))
                if my_utils.e_distance(a.state.position, (g[0], g[1])) < self.gt_precission:
                    r[i] = 1
