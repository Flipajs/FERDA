...
if __name__ == "__main__":
    image = cv2.imread("/home/dita/ownCloud/FERDA/sample.png")
    # helper = SegmentationHelper(image)
    """
    import matplotlib.pyplot as plt
    ...
    lbp = get_lbp(image)
    # print lbp
    cv2.imwrite("/home/dita/ownCloud/FERDA/lbp_test_out.png", lbp*(255/lbp.max()))
