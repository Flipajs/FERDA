...
class CompleteSetMatching:
    ...
    def process(self):
        ...
        # 2. is there any nonconflicting track in ?5? frames neighborhood, try to match on this
        # 3. else choosen one from 3 biggest
    ...
    def get_track_prototypes(self, tracklet, n=10, debug=False):
