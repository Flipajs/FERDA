...
class Project:
    ...
    def load(self, path, snapshot=None, parent=None):
        ...
        # self.__dict__['video_paths'] = '/home/simon/FERDA/projects/clusters_gt/Cam1_/Cam1_clip.avi'
        # self.__dict__['working_directory'] = '/home/simon/FERDA/projects/clusters_gt/Cam1_'
        a_ = path.split('/')
